...
public class FeedbackResponseComment extends BaseEntity {
    ...
    public String toString() {
        return "FeedbackResponseComment [id=" + id + ", feedbackResponseId=" + feedbackResponse.getId() + ", giver=" + giver
                + ", giverType=" + giverType + ", giverSectionId=" + giverSection.getId()
                + ", recipientSectionId=" + recipientSection.getId() + ", commentText=" + commentText
